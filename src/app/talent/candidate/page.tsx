      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/talent/candidate/applications" className="text-sm text-[#3147FF] hover:underline">
              View all
            </Link>
          </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/talent/candidate/interviews" className="text-sm text-[#3147FF] hover:underline">
              View all
            </Link>
          </div>
