...
import {
  Building2, FileText, Users, Calendar, Menu, X, Bell,
} from "lucide-react";

const navItems = [
  { href: "/talent/client", label: "Dashboard", icon: Building2 },
  { href: "/talent/client/requisitions", label: "Requisitions", icon: FileText },
  { href: "/talent/client/candidates", label: "Candidates", icon: Users },
  { href: "/talent/client/interviews", label: "Interviews", icon: Calendar },
];
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      >
        <div className="flex items-center gap-3 px-5 py-5 border-b border-white/10">
          <Building2 className="w-7 h-7 text-[#3147FF]" />
          <div>
        ...
        <nav className="flex-1 px-3 py-4 space-y-1">
          {navItems.map((item) => {
            const isActive =
              item.href === "/talent/client"
                ? pathname === "/talent/client"
