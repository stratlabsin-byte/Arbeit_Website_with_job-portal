...
export default function InterviewDetailPage() {
  ...
  async function fetchInterview() {
    ...
    if (!res.ok) { router.push("/admin/interviews"); return; }
  ...
  return (
    <div>
      <Link href="/admin/interviews" className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-gray-700 mb-6">
