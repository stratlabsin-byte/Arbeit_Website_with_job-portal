...
export default function ClientNewRequisitionPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    router.push("/portal/client/requisitions");
  }

  return (
    <div className="max-w-2xl mx-auto">
      <Link href="/portal/client/requisitions" className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-gray-700 mb-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-end gap-3">
          <Link href="/portal/client/requisitions" className="px-4 py-2.5 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200">
            Cancel
          </Link>
          <button
            type="submit"
