...
export default function ClientDashboardPage() {
  ...
  const cards = [
    { label: "Requisitions", value: stats.requisitions, icon: FileText, href: "/portal/client/requisitions", color: "bg-blue-50 text-blue-600" },
    { label: "Candidates for Review", value: stats.pendingReview, icon: Users, href: "/portal/client/candidates", color: "bg-purple-50 text-purple-600" },
    { label: "Total Candidates", value: stats.candidates, icon: Users, href: "/portal/client/candidates", color: "bg-emerald-50 text-emerald-600" },
    { label: "Interviews", value: stats.interviews, icon: Calendar, href: "/portal/client/interviews", color: "bg-amber-50 text-amber-600" },
  ];
