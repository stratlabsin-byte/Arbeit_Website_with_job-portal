...
export const metadata: Metadata = {
  title: "Hire Contractors | Arbeit - Contract Staffing Solutions in India",
  description:
    "Hire skilled contractors through Arbeit. Fast onboarding, flexible workforce solutions, full compliance, and end-to-end support for businesses across India.",
  keywords: [
  ...
  openGraph: {
    title: "Hire Contractors | Arbeit",
    description:
      "Build an agile workforce with Arbeit's contract staffing solutions. Fast deployment, compliant processes, and dedicated support.",
    type: "website",
  },
};
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 py-24 sm:py-32">
        ...
        <div className="container-main relative z-10 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-blue-100">
            Build a flexible, high-performing workforce with Arbeit&apos;s
            contract staffing solutions. Deploy skilled professionals quickly
            and scale on demand.
          </p>
          <div className="mt-10">
        ...
        <div className="container-main">
          ...
          <div className="mt-16 grid gap-8 sm:grid-cols-2">
            {helpCards.map((card) => (
              <div
                key={card.title}
                className="card group hover:shadow-xl transition-shadow duration-300 border-l-4 border-l-blue-700"
              >
      ...
      <section className="py-20 sm:py-28 bg-gradient-to-br from-blue-900 to-indigo-900">
        <div className="container-main text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-blue-100">
            Let Arbeit handle the complexity of contract staffing while you
            focus on driving your business forward. Get in touch today.
          </p>
